		...
		while ($row=mysqli_fetch_row($result))
	   	{
			if($bid==$row[15])
			{
				...
				{
					$r[2] = $r[2] - 1;
					$sql2 = "UPDATE rooms_count SET available_rooms='$r[2]'WHERE room_type='$room'";
					...
					$sql2 = "INSERT INTO `confirmed_booking`(`phone`, `id_user`, `idproof`, `room_type`, `checkin`, `checkout`, `days`, `ac`, `breakfast`, `lunch`, `snacks`, `dinner`, `swimming`, `price`, `book_id`) VALUES 
